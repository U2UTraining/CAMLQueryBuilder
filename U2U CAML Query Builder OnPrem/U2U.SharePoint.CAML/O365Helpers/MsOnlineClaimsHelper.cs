...
namespace Wictor.Office365
{
    public class MsOnlineClaimsHelper
    {
        ...
        private const string userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4501.0 Safari/537.36 Edg/92.0.891.1";
        #endregion
