    ...
    public class QueryUserControl : System.Windows.Forms.UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.queryTreeview.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.queryTreeview.ContextMenu = this.treeviewContextMenu;
            ...
            : this()
        {
            ...
            InitializeVariablesAndControls(true);
            if (builder == null)
            {
        ...
        public System.Guid ListGuid
        {
            ...
            set
            {
                ...
                if (sharepointSite != null)
                    InitializeVariablesAndControls(false);
            }
        }
        ...
        private void InitializeVariablesAndControls(bool isInitializing)
        {
            try
            {
                if (isInitializing)
        ...
        private void FillFieldsListBox()
        {
            // fill the listbox
            switch (selectedQueryType)
            {
                ...
                case CamlTypes.GetListItemChanges:
                    {
                        ...
                        UtilityFunctions.FillFields(fieldsFromListBox, query);
                        UtilityFunctions.FillFields(ContainsFieldsListBox, query);
                        break;
                    }
        ...
        private void FillQueryUserControl(XmlDocument camlDocument)
        {
        ...
        private void whereCheckBox_CheckedChanged(object sender, System.EventArgs e)
        {
            try
            {
                if (selectedFieldObject == null) return;
                ...
                if (whereCheckBox.Checked)
                {
                    ...
                    if (selectedFieldObject.TypeAsString == U2U.SharePoint.CAML.Enumerations.DataTypes.Lookup.ToString())
                    {
                        ...
                        UtilityFunctions.FillLookupComboBox(valueComboBox, query.Site, selectedFieldObject);
                    }
        ...
        private void ContainsFieldsListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (selectedFieldObject == null ||
                    selectedFieldObject.InternalName != ((FieldObject)ContainsFieldsListBox.SelectedItem).InternalName)
                {
                    ...
                    if (selectedFieldObject.TypeAsString == U2U.SharePoint.CAML.Enumerations.DataTypes.Lookup.ToString())
                    {
                        ...
                        UtilityFunctions.FillLookupComboBox(ContainsValueComboBox, query.Site, selectedFieldObject);
                    }
                    else if (selectedFieldObject.TypeAsString == U2U.SharePoint.CAML.Enumerations.DataTypes.Choice.ToString()
                        || selectedFieldObject.TypeAsString == U2U.SharePoint.CAML.Enumerations.DataTypes.MultiChoice.ToString())
                    {
