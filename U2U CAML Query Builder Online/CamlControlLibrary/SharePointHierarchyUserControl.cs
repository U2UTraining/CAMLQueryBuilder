namespace U2U.CamlControlLibrary
{
    ...
    public class SharePointHierarchyUserControl : System.Windows.Forms.UserControl
    {
        ...
        private System.Windows.Forms.ToolStripMenuItem updateListItemsMenuItem;
        private System.Windows.Forms.ContextMenuStrip serverContextMenu;
        private System.Windows.Forms.ToolStripMenuItem getListItemsMenuItem;
        private System.Windows.Forms.ToolStripMenuItem queryMenuItem;
        private System.Windows.Forms.ToolStripMenuItem clientQueryMenuItem;
        private ToolStripMenuItem getListItemChangesMenuItem;
        private ToolStripMenuItem getListItemChangesSinceTokenMenuItem;
        ...
        private void InitializeComponent()
        {
            ...
            this.clientContextMenu = new System.Windows.Forms.ContextMenuStrip();
            this.clientQueryMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.getListItemsMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.getListItemChangesMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.getListItemChangesSinceTokenMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.updateListItemsMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            // clientContextMenu
            // 
            this.clientContextMenu.Items.AddRange(new System.Windows.Forms.ToolStripMenuItem[] {
            ...
            // clientQueryMenuItem
            // 
            this.clientQueryMenuItem.MergeIndex = 0;
            ...
            // 
            this.getListItemsMenuItem.MergeIndex = 1;
            ...
            // 
            this.getListItemChangesMenuItem.MergeIndex = 2;
            ...
            // 
            this.getListItemChangesSinceTokenMenuItem.MergeIndex = 3;
            ...
            // 
            this.updateListItemsMenuItem.MergeIndex = 4;
            ...
            // serverContextMenu
            // 
            this.serverContextMenu.Items.AddRange(new System.Windows.Forms.ToolStripMenuItem[] {
            this.queryMenuItem});
            // 
            // queryMenuItem
            // 
            this.queryMenuItem.MergeIndex = 0;
        ...
        public async Task Connect(QueryInfo queryInfo)
        {
            ...
            sharePointHierarchyTreeview.Nodes.Add(await AddWebHierarchy(queryInfo));
        }
        ...
        {
            sharePointHierarchyTreeview.ContextMenuStrip = clientContextMenu;
        }

        private async Task<TreeNode> AddWebHierarchy(QueryInfo queryInfo)
        {
            TreeNode siteNode = new TreeNode(await queryInfo.Site.GetTitle())
            {
                Tag = queryInfo,
            ...
            await GetListNodes(queryInfo, listTitleNode);
            await GetSubWebs(queryInfo, siteNode);
        ...
        private async Task GetSubWebs(QueryInfo queryInfo, TreeNode siteNode)
        {
            TreeNode webTitleNode = null;
            Collection<QueryInfo> sites = await queryInfo.Site.GetSites();
            if (sites.Count > 0)
            {
        ...
        private async Task GetListNodes(QueryInfo queryInfo, TreeNode listTitleNode)
        {
            foreach (var list in await queryInfo.Site.GetLists())
            {
